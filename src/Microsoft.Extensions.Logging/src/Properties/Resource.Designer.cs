...
namespace Microsoft.Extensions.Logging
{
    ...
    internal static class Resource
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.Extensions.Logging.Resource", typeof(Resource).GetTypeInfo().Assembly);
        ...
        {
            get => GetString("UnexpectedNumberOfNamedParameters");
        }
        ...
        internal static string FormatUnexpectedNumberOfNamedParameters(object p0, object p1, object p2)
            => string.Format(CultureInfo.CurrentCulture, GetString("UnexpectedNumberOfNamedParameters"), p0, p1, p2);
